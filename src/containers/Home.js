        ...
        <Box sx={{ minHeight: "100vh", bgcolor: "background.default", color: "text.primary" }}>
            <Box sx={{ bgcolor: "background.paper", borderBottom: "1px solid", borderColor: "divider" }}>
                <Container maxWidth="lg">
                    <Box sx={{ py: { xs: 3.5, md: 4.5 } }}>
                        <Typography sx={{
                            color: "primary.main", fontSize: 12, fontWeight: 800,
                            letterSpacing: 2, mb: 1
                        }}>
                        ...
                        <Typography component="h1" sx={{
                            ...
                            letterSpacing: "-.03em", mb: 1
                        }}>
                            Technische Werkzeuge
                        </Typography>

                        <Typography color="text.secondary" sx={{ maxWidth: 650, lineHeight: 1.6 }}>
            ...
            <Container maxWidth="lg">
                <Box sx={{ py: { xs: 4, md: 5 } }}>
                    ...
                    <Paper
                        onClick={() => navigate("/biegeberechnung")}
                        elevation={0}
                        sx={{
                            width: "100%",
                            textAlign: "left",
                                ...
                                <Box sx={{ p: { xs: 2.5, md: 3.5 } }}>
                                    <Box sx={{
                                        ...
                                        <Box sx={{
                                            ...
                                            <ArchitectureIcon sx={{ fontSize: 25 }} />
                                        </Box>
                                    ...
                                    <Typography color="text.secondary" sx={{
                                        ...
                                        Berechnung der Parameter für die thermische Biegung
                                        von PVC und anderen thermoplastischen Materialien.
                                    </Typography>
                    ...
                    <Box sx={{
                        ...
                        <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.65 }}>
                            Die Werkzeuge dienen als technische Unterstützung bei Berechnungen
                            und der Vorbereitung von Arbeitsprozessen. Ergebnisse sind anhand
                            der jeweiligen technischen Zeichnungen, Maschinenparameter und
                            betrieblichen Vorgaben zu prüfen.
                        </Typography>
                    </Box>
                </Box>
            </Container>
